                  ...
                  <div class="row leb-product"> 
                        ...
                        <div class="col-md-2">
                            <select  class="filter2 filter-btn" onchange="location = this.options[this.selectedIndex].value;">
                                ...
                                <option value="acCom.php" /> Combination<br />
                            </select>
                        </div>
                        <div class="col-md-2">
...
<!-- Products Listed -->
			...
			<div class="row">
					<div class="col-xs-4 tolak-product showimg acne oil com 1">
						<div class=" a">
...
6-in-1 Anti-Acne Foam</b><p>Combat 6 signs of acne day after day.
					...
					<div class="col-xs-4 tolak-product showimg acne oil com 1">
						<div class=" a">
            				<img src="images/men/acno-fight/AcnoFightAntiImpefectionsCoolingToner.png" class='hold' />
        				</div>
				        <div class="col-xs-6 b">
					...
					<div class="col-xs-4 tolak-product showimg acne oil com 1">
						<div class=" a">
            				<img src="images/men/acno-fight/AcnoFightWasabiFoam.png" class='hold' />
        				</div>
				        <div class="col-xs-6 b">
					...
					<div class="col-xs-4 tolak-product showimg acne oil com 1">
						<div class=" a">
            				<img src="images/men/acno-fight/AcnoFightAcneFightingWhiteningSerum.png" class='hold' />
        				</div>
				        <div class="col-xs-6 b">
