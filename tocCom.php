...
<!-- Begin Content -->
	<div id="content">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<div class="breadcrumb"> <a href="index.php">Home</a> > <a href="#">Garnier Men</a> > TurboLight Oil Control
					</div>
				</div>
			</div>
			<div class="row">
                  ...
                  <div class="row leb-product"> 
                        ...
                        <div class="col-md-2">
                            <select class="filter2 filter-btn" onchange="location = this.options[this.selectedIndex].value;">
                                ...
                                <option value="tocCom.php" /> Combination<br />
                            </select>
                        </div>
                        <div class="col-md-2">
